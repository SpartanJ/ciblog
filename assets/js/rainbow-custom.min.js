/* Rainbow v1.1.4 rainbowco.de | included languages: c, shell, generic, javascript, python, html, php, ruby, css */
...
a.replace(/\./g," ")+(k?" "+k:"")+'">'+b+"</span>"}function E(a,b){var c=0,d;for(d=1;d<b;++d)a[d]&&(c+=a[d].length);return c}function s(a,b,c,d){var f=a.exec(c);if(f){++t;!b.name&&"string"==typeof b.matches[0]&&(b.name=b.matches[0],delete b.matches[0]);var h=f[0],j=f.index,u=f[0].length+j,l=function(){function f(){s(a,b,c,d)}t%100>0?f():setTimeout(f,0)};if(D(j,u))l();else{var m=v(b.matches),k=function(a,c,d){if(a>=c.length)d(h);else{var e=function(){k(++a,c,d)},g=f[c[a]];if(g){var j=b.matches[c[a]],
i=j.language;if(i)n(g,i,function(a){h=h.replace(g,a);e()});else if(typeof j==="object")w(g,j.length?j:[j],function(a){h=h.replace(g,a);e()});else{h=x(E(f,c[a]),g,r(j,g),h);e()}}else e()}};k(0,m,function(a){b.name&&(a=r(b.name,a));if(!i[e]){i[e]={};g[e]={}}i[e][j]={replace:f[0],"with":a};g[e][j]=u;l()})}}else d()}function x(a,b,c,d){return d.substr(0,a)+d.substr(a).replace(b,c)}function v(a){var b=[],c;for(c in a)a.hasOwnProperty(c)&&b.push(c);return b.sort(function(a,c){return c-a})}function w(a,
b,c){function d(b,h){h<b.length?s(b[h].pattern,b[h],a,function(){d(b,++h)}):F(a,function(a){delete i[e];delete g[e];--e;c(a)})}++e;d(b,0)}function F(a,b){function c(a,b,d,g){if(d<b.length){++y;var l=b[d],k=i[e][l],a=x(l,k.replace,k["with"],a),l=function(){c(a,b,++d,g)};0<y%250?l():setTimeout(l,0)}else g(a)}var d=v(i[e]);c(a,d,0,b)}function n(a,b,c){var d=m[b]||[],f=m[z]||[],b=A[b]?d:d.concat(f);w(a.replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/&(?![\w\#]+;)/g,"&amp;"),b,c)}function o(a,b,c){if(b<
a.length){var d=q(a[b])||q(a[b].parentNode);return!(-1<(" "+a[b].className+" ").indexOf(" rainbow "))&&d?(d=d.toLowerCase(),C(a[b]),n(a[b].innerHTML,d,function(f){a[b].innerHTML=f;i={};g={};p&&p(a[b],d);setTimeout(function(){o(a,++b,c)},0)})):o(a,++b,c)}c&&c()}function B(a,b){var a=a&&"function"==typeof a.getElementsByTagName?a:document,c=a.getElementsByTagName("pre"),d=a.getElementsByTagName("code"),f,e=[];for(f=0;f<d.length;++f)e.push(d[f]);for(f=0;f<c.length;++f)c[f].getElementsByTagName("code").length||
e.push(c[f]);o(e,0,b)}var i={},g={},m={},A={},e=0,z=0,t=0,y=0,k,p;return{extend:function(a,b,c){1==arguments.length&&(b=a,a=z);A[a]=c;m[a]=b.concat(m[a]||[])},b:function(a){p=a},a:function(a){k=a},color:function(a,b,c){if("string"==typeof a)return n(a,b,c);if("function"==typeof a)return B(null,a);B(a,b)}}}();window.addEventListener?window.addEventListener("load",Rainbow.color,!1):window.attachEvent("onload",Rainbow.color);Rainbow.onHighlight=Rainbow.b;Rainbow.addClass=Rainbow.a;Rainbow.color=Rainbow.color;Rainbow.extend("c",[{name:"meta.preprocessor",pattern:/\#[\S\s]*?$/gm},{name:"comment",pattern:/\/\*[\s\S]*?\*\/|\/\/[\s\S]*?$/gm},{name:"keyword",pattern:/\b(do|goto|continue|break|switch|case|typedef)\b/g},{name:"entity.label",pattern:/\w+:/g},{name:"storage.type",pattern:/\b(((un)?signed|const)\s)?(void|char|short|int|long|float|double)\b/g},{name:"storage.modifier",pattern:/\b(static|extern|auto|register|volatile|inline)\b/g},{name:"support.type",pattern:/\b(struct|union|enum)\b/g}]);Rainbow.extend("shell",[{name:"shell",matches:{1:{language:"shell"}},pattern:/\$\(([\s\S]*?)\)/gm},{matches:{2:"string"},pattern:/(\(|\s|\[|\=)(('|")[\s\S]*?(\3))/gm},{name:"keyword.operator",pattern:/&lt;|&gt;|&amp;/g},{name:"comment",pattern:/\#[\s\S]*?$/gm},{name:"storage.function",pattern:/(.+?)(?=\(\)\s{0,}\{)/g},{name:"support.command",pattern:/\b(echo|rm|ls|(mk|rm)dir|cd|find|cp|exit|pwd|exec|trap|source|shift|unset)/g},{matches:{1:"keyword"},pattern:/\b(break|case|continue|do|done|elif|else|esac|eval|export|fi|for|function|if|in|local|return|set|then|unset|until|while)(?=\(|\b)/g}],
!0);Rainbow.extend([{matches:{1:{name:"keyword.operator",pattern:/\=/g},2:"string"},pattern:/(\(|\s|\[|\=)(('|")[\s\S]*?(\3))/gm},{name:"comment",pattern:/\/\*[\s\S]*?\*\/|(\/\/|\#)[\s\S]*?$/gm},{name:"constant.numeric",pattern:/\b(0x[\da-f]+|\d+)\b/gi},{name:"constant.numeric",pattern:/\b((\d+\.\d*)|(\d*\.\d+))((e|E)(\+|\-)?\d+)?(f|F|d|D)?\b/g},{name:"constant",pattern:/\b[A-Z0-9_]{2,}\b/g},{matches:{1:"keyword"},pattern:/\b(and|array|as|bool(ean)?|c(atch|har|lass|onst)|d(ef|elete|ie|o(uble)?)|e(cho|lse(if)?|xit|xtends|xcept)|f(inally|loat|or(each)?|unction)|global|if|import|int(eger)?|long|new|object|or|pr(int|ivate|otected)|public|return|self|st(ring|ruct|atic)|switch|th(en|is|row)|try|(un)?signed|var|void|while)(?=\(|\b)/gi},
...
pattern:/(\w+)/g}],3:"support.tag.script"},pattern:/(&lt;\/?)(script.*?)(&gt;)/g},{name:"string.regexp",matches:{1:"string.regexp.open",2:{name:"constant.regexp.escape",pattern:/\\(.){1}/g},3:"string.regexp.close",4:"string.regexp.modifier"},pattern:/(\/)(?!\*)(.+)(\/)([igm]{0,3})/g},{matches:{1:"storage",2:"entity.function"},pattern:/(var)\s(.*)(?=\s?=\s?function\()/g},{name:"entity.function",pattern:/(\w+)(?=:\s{0,}function)/g}]);Rainbow.extend("python",[{name:"variable",pattern:/\b[A-Z0-9_]{2,}\b/g},{name:"variable.self",pattern:/self/g},{name:"constant.language",pattern:/None|True|False/g},{name:"support.object",pattern:/object/g},{matches:{1:"keyword"},pattern:/\b(pass|lambda|with|is|not|in|from|elif)(?=\(|\b)/g},{matches:{1:"storage.class",2:"entity.name.class",3:"entity.other.inherited-class"},pattern:/(class)\s+(\w+)\((\w+?)\)/g},{matches:{1:"storage.function",2:"support.magic"},pattern:/(def)\s+(__\w+)(?=\()/g},{matches:{1:"storage.function",
2:"entity.name.function"},pattern:/(def)\s+(\w+)(?=\()/g},{name:"entity.name.function.decorator",pattern:/@(\w+)/g},{name:"comment.docstring",pattern:/('{3}|"{3})[\s\S]*\1/gm}]);Rainbow.extend("html",[{name:"source.php.embedded",matches:{2:{language:"php"}},pattern:/&lt;\?(php)?([\s\S]*?)(\?&gt;)/gm},{name:"source.css.embedded",matches:{"0":{language:"css"}},pattern:/&lt;style(.*?)&gt;([\s\S]*?)&lt;\/style&gt;/gm},{name:"source.js.embedded",matches:{"0":{language:"javascript"}},pattern:/&lt;script(?! src)(.*?)&gt;([\s\S]*?)&lt;\/script&gt;/gm},{name:"comment.html",pattern:/&lt;\!--[\S\s]*?--&gt;/g},{matches:{1:"support.tag.open",2:"support.tag.close"},pattern:/(&lt;)|(\/?&gt;)/g},
